...
impl SubstrateCli for Cli {
    ...
    fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
        ...
        Ok(match id {
            ...
            name if name.starts_with("kusama-") && !name.ends_with(".json") => Err(format!(
            ...
            name if name.starts_with("rococo-") && !name.ends_with(".json") => Err(format!(
            ...
            name if name.starts_with("westend-") && !name.ends_with(".json") => Err(format!(
